...
template<class ItemType>
void BST_312 <ItemType>::deleteItem(TreeNode*& t, const ItemType& newItem) //postorder LRN
{
    if (t == NULL)
        return;
...
void BST_312 <ItemType>::makeEmpty(TreeNode*& t)
{
    ...
    while( t != NULL)
    {
        // BST_312 <ItemType>::deleteItem(TreeNode*& t, const ItemType& newItem)
        deleteItem(t, t->data);
    }
...
void BST_312 <ItemType>::insertItem(TreeNode*& t, const ItemType& newItem)
{
    ...
    else if(newItem > t->data && t->right != NULL)
...
template<class ItemType>
void BST_312 <ItemType>::preOrderTraversal(TreeNode* t,vector<ItemType>& result) const //NLR
{
    //YOUR CODE GOES HERE
    if( t == NULL)
        return;
...
template<class ItemType>
void BST_312 <ItemType>::inOrderTraversal(TreeNode* t,vector<ItemType>& result) const //LNR
{
    //YOUR CODE GOES HERE
    if( t == NULL)
        return;
...
template<class ItemType>
void BST_312 <ItemType>::postOrderTraversal(TreeNode* t,vector<ItemType>& result) const //LRN
{
    //YOUR CODE GOES HERE
    if( t == NULL)
        return;
...
bool BST_312 <ItemType>::isItemInTree(const ItemType& item)
{
    ...
    preOrderTraversal(this->root, check);
